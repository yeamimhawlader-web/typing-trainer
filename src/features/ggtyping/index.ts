...
export { keepTroublesomeWords } from './hover/word-mistakes.ts'
export { newTestId } from './hover/hover-controller.ts'
export type { WordMistakeOptions } from './hover/word-mistakes.ts'
