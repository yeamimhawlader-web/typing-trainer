...
// Defaults made once, not on every render.
const DEFAULT_TITLE = <span className="font-light text-foreground tracking-tighter">Welcome</span>;
          ...
          <div className="flex flex-col gap-6">
            ...
            <form className="space-y-5" onSubmit={onSignIn}>
              <div className="animate-element animate-delay-300">
                <label htmlFor={`${id}-email`} className="text-sm font-medium text-muted-foreground">Email Address</label>
                <GlassInputWrapper>
                  <input id={`${id}-email`} name="email" type="email" autoComplete="email" placeholder="Enter your email address" className="w-full border-0 bg-transparent text-sm p-4 rounded-2xl focus:outline-none" />
                </GlassInputWrapper>
              </div>
