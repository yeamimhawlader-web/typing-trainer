...
function LiquidButton({
  ...
  const Comp = asChild ? Slot : "button"
  // With asChild, the child (a link, say) becomes the button: the glass layers
  // go inside it, around its own content. Slot takes a single child, so the
  // child is marked with Slottable and the layers sit beside it.
...
>(({ children, className, variant = "default", ...props }, ref) => {
  ...
  // Known on the first render: nothing to wait for, so no effect to set it.
